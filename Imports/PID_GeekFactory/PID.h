...
/* Modified for use with TI-RTOS on MSP430F5529 by Jacob Faseler
 * 		Oct 27 2019
 * 		ESET 462
...
/*-------------------------------------------------------------*/
/*		Alterations for TI-RTOS			*/
/*-------------------------------------------------------------*/

//#include "Tick/Tick.h" /* Was under includes and dependancies*/

/* Assuming Tick Period of 5000 uS
* (.cfg/Products/SYSBIOS/Scheduling/Clock)
*/
#define TICK_SECOND 1000

/* SysBios doesn't permit returning bool to void, so that return
 * was replaced with systme abort to indicate a bad call than needs
 * fixing. */
#include <xdc/runtime/System.h>

/* SysBios equivelant of Tick.h (minor differences) */
